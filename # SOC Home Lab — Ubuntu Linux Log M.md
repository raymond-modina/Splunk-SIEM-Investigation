# SOC Home Lab — Ubuntu Linux Log Monitoring with Splunk Enterprise
...
The VMware NAT Service was not enabled and then restarted.
...
Connection to 192.168.x.x 9997 port [tcp/*] succeeded!
